      ...
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
              Проект разрабатывается Когортой 37 — командой, которая верит в 
              силу совместного обучения. Для нас это не только возможность 
              применить современные технологии на практике, но и шанс создать
              действительно полезный продукт, объединяющий людей через обмен 
              знаниями.
            </p>
          </div>
        </section>
